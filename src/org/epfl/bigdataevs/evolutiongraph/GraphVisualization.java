...
public class GraphVisualization {
   ...
   */
  public static void generateGraphFromRdd(String filename, TimePeriod timePeriod, JavaRDD<LightTheme> themesRdd, JavaRDD<EvolutionaryTransition> transitionGraph){
    final TimePeriod tp = timePeriod;
    
    System.out.println("Retrieving nodes");
    
    List<Tuple2<Date, Iterable<String>>> nodes = themesRdd.flatMapToPair(new PairFlatMapFunction<LightTheme,Date,String>(){
      @Override
      public Iterable<Tuple2<Date, String>> call(LightTheme theme) throws Exception {
